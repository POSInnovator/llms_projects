...
persistent_directory = os.path.join(db_dir, "faiss_db_huggingface")
...
query_vector_store("faiss_db_huggingface", query,embeddings, "similarity", {"k": 3})
...
query_vector_store("faiss_db_huggingface",query,embeddings,"mmr",{"k": 3, "fetch_k": 20, "lambda_mult": 0.5},)
...
query_vector_store("faiss_db_huggingface",query,embeddings,"similarity_score_threshold",{"k": 3, "score_threshold": 0.1},)
